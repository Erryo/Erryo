...
### 🎮 [animated-sniffle](https://github.com/Erryo/animated-sniffle)
An attempt at making my own game from start using SDL2 and Go - includes "Sniffle Shoots Asteroids", a replica of the classic Asteroids game.

### 📦 [Programming](https://github.com/Erryo/Programming)
A comprehensive repository of all my personal code projects including:
- 3D LightPipe animation with Blender Python
